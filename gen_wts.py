...
def parse_args():
    ...
    parser.add_argument('-w', '--weights', default="yolov5s.pt",  help='Input weights (.pt) file path (required)')
    parser.add_argument('-o', '--output', default="yolov5s.wts", help='Output (.wts) file path (optional)')
